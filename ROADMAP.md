...
[R026] per-profile **collision radius** (2026-06-08) — truck 2.5 m / van 2.2 / muscle 2.0 / sedan 1.9 / interceptor 1.85 / sports 1.75 / compact 1.6; wired in wall-resolve, car-vs-car separation, pedestrian reach, actor push-out, and police feeler. Class hierarchy test added. ·
[R031] **Branding** (2026-06-08) — `<title>`, PWA meta, and splash alt-text updated to "GTA 7 — Guns, Traffic & Anarchy".
